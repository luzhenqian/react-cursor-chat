...
var Latency = function Latency(_ref) {
  ...
  }, flag(latencyData.meshId), " ", latencyData.meshId), React.createElement("span", {
...
var OtherCursor = function OtherCursor(_ref) {
  ...
  return useMemo(function () {
    ...
    }, cursor.name)), msg && React.createElement("div", {
...
var MeCursor = function MeCursor(_ref) {
  ...
  return useMemo(function () {
    return React.createElement("div", {
      ...
      className: "online-cursor-wrapper__name"
    }, cursor.name)), showInput && React.createElement("div", {
