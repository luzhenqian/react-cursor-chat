...
var Cursor = /*#__PURE__*/function () {
  function Cursor(id, x, y, name, avatar) {
    this.id = id;
    this.x = x;
    this.y = y;
    this.name = name;
...
var Me = /*#__PURE__*/function (_Cursor) {
  ...
  function Me(_ref) {
    ...
    _this = _Cursor.call(this, id, x, y, name, avatar) || this;
  ...
  _proto.goOffline = /*#__PURE__*/function () {
    var _goOffline = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
...
var Other = /*#__PURE__*/function (_Cursor) {
  ...
  function Other(_ref) {
    var id = _ref.id,
        ...
        _ref$avatar = _ref.avatar,
        avatar = _ref$avatar === void 0 ? '' : _ref$avatar;
    return _Cursor.call(this, id, x, y, name, avatar) || this;
  }
...
var COUNTRY_RE = /^[a-z]{2}$/i;
var MAGIC_NUMBER = 127462 - 65;

var flag = function flag(country) {
  if (!country || !COUNTRY_RE.test(country)) {
    return '';
  }

  if (String && String.fromCodePoint) {
    return String.fromCodePoint.apply(String, country.split('').map(function (c) {
...
var Latency = function Latency(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    className: "online-cursor-wrapper__meshId"
  }, flag(latencyData.meshId), " ", latencyData.meshId), React__default.createElement("span", {
...
var OtherCursor = function OtherCursor(_ref) {
  ...
  return React.useMemo(function () {
    return React__default.createElement("div", {
      ...
      color: cursor.color
    }), React__default.createElement(Latency, {
      cursor: cursor,
    ...
    }, cursor.name)), msg && React__default.createElement("div", {
...
var MeCursor = function MeCursor(_ref) {
  ...
  return React.useMemo(function () {
    return React__default.createElement("div", {
      ...
      className: "online-cursor-wrapper__name"
    }, cursor.name)), showInput && React__default.createElement("div", {
